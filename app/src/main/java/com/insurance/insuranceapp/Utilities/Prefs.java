...
public class Prefs {
     ...
     * Set)}.
     * <strong>Note that the native implementation of {@linkEditor # putStringSet(String,
     * Set)} does not reliably preserve the order of the Strings in the Set.</strong>
     *
     * @param key   The name of the preference to modify.
     * @param value The new value for the preference.
     ...
     *
     * @return the {@linkEditor} for chaining. The changes have already been committed/applied
    ...
    public final static class Builder {
         ...
         * @return the {@linkcom.pixplicity.easyprefs.library.Prefs.Builder} object.
         */
